...
module.exports = function(myself) {
    ...
    text[1] = `*Caso você não queira seu _${myself.phone}_ conectado no _Myzap-Flow ${versionFlow.version}_ apenas vá nas configurações do seu WhatsApp e apague todos os dispositivos logados no WhatsApp Web.*`
